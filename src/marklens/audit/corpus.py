...
CORPUS: tuple[Case, ...] = (
    ...
    _p("nbsp in prose", f"10{NBSP}km", "10 km",
       ...
       "whitespace"),
    _p("ideographic space", "a　b", "a b",
       "as above, in CJK text where it may be deliberate",
       "whitespace"),
    _p("em dash in prose", "clear—truly", "clear—truly",
       "legitimate prose typography; folding it is cosmetic damage, not cleaning",
       "typography"),
    _p("curly quotes in prose", "she said “hi”", "she said “hi”",
       "as above",
       "typography"),
    _p("ellipsis in prose", "wait…", "wait…",
       "as above",
       "typography"),
    _p("curly quotes in a code span", "run `x = “y”` now",
       'run `x = "y"` now',
       "a curly quote inside code is a syntax error even in a prose document",
       "typography"),
    _p("curly quotes in a fenced block", "```\nn = “v”\n```",
       '```\nn = "v"\n```',
       "as above",
       "typography"),
